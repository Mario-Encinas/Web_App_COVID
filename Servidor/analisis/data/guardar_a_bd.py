...
try:
    cur.execute("DELETE FROM analisis_datos_pacientes")
    cur.execute("DELETE FROM analisis_antecedentes_pacientes")
    cur.execute("DELETE FROM analisis_informacion_medica")
    myConnection.commit()
